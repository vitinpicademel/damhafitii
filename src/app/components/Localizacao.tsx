...
=======
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border-8 border-white">
              <div className="aspect-[16/9] relative">
                <Image
                  src="/images/galeria/mapa-damha.jpg"
                  alt="Mapa do empreendimento"
                  fill
                  className="object-cover"
                />
              </div>
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 via-black/30 to-transparent h-1/3 pointer-events-none"></div>
              <div className="absolute bottom-6 left-6">
                <a 
                  href="https://maps.google.com/?q=Av. Niza Marquez Guaritá, Uberaba - MG"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white/95 hover:bg-[#00A651] hover:text-white text-[#00A651] px-6 py-3 rounded-lg shadow-xl transition-all duration-300 flex items-center space-x-2 backdrop-blur-sm"
                >
...
=======
                    <p className="text-gray-600 leading-relaxed">Av. Niza Marquez Guaritá, Uberaba - MG</p>
>>>>>>> c066f610c68a3167bc59713f866782e719656391
                  </div>
                </div>
